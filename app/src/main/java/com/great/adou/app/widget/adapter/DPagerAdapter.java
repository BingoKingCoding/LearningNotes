...
import com.great.adou.app.widget.listener.DItemClickCallback;
...
/**
 * <PagerAdapter基类>
 * Created by WangWB on 2018/06/05  11:29.
 */
public abstract class DPagerAdapter<T> extends PagerAdapter implements IAdapter<T> {

    private Activity mActivity;
    private List<T> mListModel;
    private SparseArray<View> mArrCacheView = new SparseArray<>();
    private boolean mAutoCacheView = false;
    private DItemClickCallback mItemClickCallback;

    public DPagerAdapter(Activity activity, List<T> listModel) {
        this.mListModel = listModel == null ? new ArrayList<>() : listModel;
    ...
    public void setItemClickCallback(DItemClickCallback<T> itemClickCallback) {
