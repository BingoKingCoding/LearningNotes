...
public class SelectManager<T>
{
    ...
    private IObjectsHolder<SelectCallback<T>> mSelectCallbackHolder = new ObjectsHolder<>();
    ...
    private void synchronizeSelected(int index)
    {
        ...
        if (model instanceof SelectManager.Selectable)
        {
    ...
    {
        mSelectCallbackHolder.foreach(new IterateCallback<SelectCallback<T>>()
        {
            @Override
