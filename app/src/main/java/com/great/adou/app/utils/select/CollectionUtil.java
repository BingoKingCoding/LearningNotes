...
public class CollectionUtil
{
    ...
    public static <T> boolean foreach(int count, SimpleIterateCallback callback)
    {
    ...
    public static <T> boolean foreachReverse(int count, SimpleIterateCallback callback)
    {
        if (count > 0 && callback != null)
        {
